        ...
        <div id="layoutSidenav">
          <?php include_once('includes/sidebar.php');?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-xl-3 col-md-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-uppercase mb-1">Total Registered Users</div>
                ...
                <?php
                $query3=mysqli_query($con,"select id from users where date(u_posting_date)>=now() - INTERVAL 30 day");
                ...
                <div class="col-xl-3 col-md-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-uppercase mb-1">Registered Users in Last 30 Days</div>
                          <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $last30daysregusers;?></div>
                        </div>
                        <div class="col-auto">
