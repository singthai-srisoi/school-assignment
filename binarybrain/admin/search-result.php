...
$ret=mysqli_query($con,"select * from users where (u_name like '%$searchkey%' || u_email like '%$searchkey%' || u_contactno like '%$searchkey%')");
                              $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['u_contactno'];?></td>  <td><?php echo $row['u_posting_date'];?></td>
                                  <td>
