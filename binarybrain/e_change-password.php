...
if(isset($_POST['update']))
{
    ...
    $sql=mysqli_query($con,"SELECT u_password FROM users where u_password='$oldpassword'");
    $num=mysqli_fetch_array($sql);
    if($num>0)
    {
    $userid=$_SESSION['id'];
    $ret=mysqli_query($con,"update users set u_password='$newpassword' where id='$userid'");
    echo "<script>alert('Password Changed Successfully !!');</script>";
    echo "<script type='text/javascript'> document.location = 'e_change-password.php'; </script>";
    }
    else
    {
