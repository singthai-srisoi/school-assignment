...
if(isset($_POST['update']))
{
    ...
    $userid=$_SESSION['id'];
    $msg=mysqli_query($con,"update users set u_name='$name',u_contactno='$contact',u_address='$address' where id='$userid'");

if($msg)
{
    echo "<script>alert('Profile updated successfully');</script>";
       echo "<script type='text/javascript'> document.location = 'e_edit-profile.php'; </script>";
}
}
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                       <th>Contact No.</th>
                                       <td colspan="3"><input class="form-control" id="u_contactno" name="u_contactno" type="text" value="<?php echo $result['u_contactno'];?>"  pattern="[0-9]{10}" title="10 numeric characters only"  maxlength="10" required /></td>
                                   </tr>
