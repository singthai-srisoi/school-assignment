...
$row1=mysqli_query($con,"select u_email,u_password,u_name from users where u_email='$femail'");
$row2=mysqli_fetch_array($row1);
if($row2>0)
{
$toemail = $row2['u_email'];
$fname = $row2['u_name'];
$subject = "Information about your password";
$password=$row2['u_password'];
$message = "Your password is ".$password;
$mail->isSMTP();                            // Set mailer to use SMTP
$mail->Host = 'smtp.gmail.com';             // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                     // Enable SMTP authentication
$mail->Username = 'binarybrain87@gmail.com';  // SMTP username
$mail->Password = 'Binarybrain@87';         // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('binarybrain87@gmail.com','noreply');
